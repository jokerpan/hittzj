	...
	<div class="login-continer">
		<div class="register-continer">
			...
			<ul style="height:30px;width:100%;margin-bottom: 70px;">
				<li class="float color" style="width:25%;" id="pre">上一页</li>
				<li class="float color" style="width:50%;">
					<p class="float">当前页数(共${requestScope.CSList.totalPageCount
						}页)：</p>
					<p class="float" id="pagenum">${requestScope.CSList.currentPage
						}</p>
				</li>
