...
<body>
	<div class="login-continer">
		<div class="register-continer">
			...
			<ul style="width:100%; margin-top:10px;" id="list" class = "list">
				<li><img src="${requestScope.CNList.list[0].img}" alt=""
					...
					<div>
						...
						<p>
							商品编号：<small class="num">${requestScope.CNList.list[0].id}</small>
						</p>
						<p>
				...
				<li><img src="${requestScope.CNList.list[1].img}" alt=""
					width="100px" height="100px;" />
					<div>
						<h4>${requestScope.CNList.list[1].name }</h4>
						<p>
							期望价格：<strong>${requestScope.CNList.list[1].money}</strong>
						</p>
						<p>
							商品编号：<small class="num">${requestScope.CNList.list[1].id
								}</small>
						</p>
						<p>
							求购人：<small>${requestScope.CNList.list[1].user.nickName }</small>
						</p>
					</div></li>
				<li><img src="${requestScope.CNList.list[2].img}" alt=""
					width="100px" height="100px;" />
					<div>
				...
				<li><img src="${requestScope.CNList.list[5].img}" alt=""
					...
					<div>
						...
						<p>
							求购人：<small>${requestScope.CNList.list[5].user.name }</small>
						</p>
					</div></li>
			...
			<ul style="height:30px;width:100%;margin-bottom: 70px;">
				<li class="float color" style="width:25%;" class="color" id="pre">上一页
				</li>
				<li class="float color" style="width:50%;">
					<p class="float">当前页数(共${requestScope.CNList.totalPageCount
						}页)：</p>
					<p class="float" id="pagenum">${requestScope.CNList.currentPage
						}</p>
				</li>
				<li class="float color" style="width:25%;text-align:right;"
					id="next">下一页</li>
				<li class="float color"><input id="pagetar" type="text"
					maxlength="3" /> <input id="pagesolr" type="button" value="跳转" />
				</li>
			</ul>
		</div>
		<div class="menu">
